import { MealInfo } from "./app/types/mealInfo"
...
export const mockDataRecipies: Meal[] = [
...
export const mealInfoCollection: (MealInfo)[] =[
    ... mockDataRecipies, 
    ...d, 
    ...e, 
    ...f, 
    ...
    for (let i = 1; i < 21; i++) {
        const ingred = recipe[`strIngredient${i.toString()}`];
        const count = recipe[`strMeasure${i.toString()}`];

        if (Boolean(ingred) && Boolean(count)) {
            ingreds.push({
                id: 1,
                title: ingred,
                count
    ...
    return {
        ...
        mealTags: recipe.strTags?.split(',') || [],
        ingredients: ingreds,
        rating: 0
    }
}).filter(recipe => recipe)

// console.log(mealInfoCollection)